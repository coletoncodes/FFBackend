...
extension Container {
    ...
    var monthlyBudgetProvider: Factory<MonthlyBudgetProviding> {
        self { MonthlyBudgetProvider() }
            .graph
    }
    ...
    var monthlyBudgetStore: Factory<MonthlyBudgetStore> {
        self { MonthlyBudgetRepository() }
            .graph
    }
